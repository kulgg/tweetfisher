    ...
    <>
      ...
      <main className="flex min-h-screen flex-col overflow-x-hidden px-2 sm:px-0">
        <div className="container mx-auto flex flex-col items-center">
          <FadeUpContainer delay={0.01} duration={0.4}>
          ...
          <div className="w-full">
            <FadeUpContainer delay={0.02} duration={0.4}>
              <div>
                <UsernameForm
                ...
                <div className="flex justify-end gap-2">
                  <a
                    ...
                    target="_blank"
                    className="mt-2 flex items-center justify-center gap-1 rounded-3xl border border-gray-500 bg-neutral-700 px-3 py-1 text-slate-200 shadow-sm shadow-gray-300 hover:border-gray-300 hover:delay-75 active:scale-105"
                  >
