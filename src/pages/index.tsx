...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      />
      <main className="mt-32 flex min-h-screen flex-col overflow-x-hidden px-2 font-default sm:px-0">
        <div className="flex flex-col items-center">
          ...
          <div className="container mx-auto flex flex-col">
            <FadeUpContainer delay={0.05} duration={0.5}>
              <h1 className="my-4 mr-auto bg-gradient-to-r from-emerald-200 to-rose-200 bg-clip-text text-center text-[39px] font-bold text-transparent sm:my-10 sm:text-7xl">
                Find Deleted Tweets
              </h1>
            </FadeUpContainer>

            <div className="w-full">
              <FadeUpContainer delay={0.2} duration={0.5}>
                <div>
                  <UsernameForm
